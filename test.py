...
subject = 'Welcome to Our Weather !'
email_sender = 'codecraftgroupproject@gmail.com'
email_password = ''  # Use the app password here
email_receiver = 'ipfi850@gmail.com'  # Replace with the actual recipient email
# SMTP server configuration
SMTP_SERVER = "smtp.gmail.com"
# Initialize Prometheus metrics for batch processing to visualise in graffana
...
def predict_and_expose_metrics():
    ...
    for visibility_row, wind_speed_row in zip(visibility_predictions.collect(), wind_speed_predictions.collect()):
        ...
        time.sleep(1)  # Adjust as necessary for real-time requirements
...
while True:
    ...
    time.sleep(2)  # Wait for 60 minutes
